...
require_capability('mod/customdocument:manage', $context);
$url = new moodle_url('/mod/customdocument/view.php', array('id' => $id, 'tab' => customdocument::ISSUED_CERTIFCADES_VIEW));
redirect($url);
die;
