...
/**
 * Base class for unit tests for mod_customdocument.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_customdocument_base_testcase extends advanced_testcase {
    ...
    /**
     * Setup function - we will create a course and add an customdocument instance to it.
     */
    ...
    /**
     * Convenience function to create a testable instance of an customdocument.
     *
     * @param array $params Array of parameters to pass to the generator
     * @return testable_customdocument Testable wrapper around the customdocument class.
     */
    protected function create_instance($params = array(), $options = null) {
        $this->setAdminUser();
        $generator = $this->getDataGenerator()->get_plugin_generator('mod_customdocument');
        $params['course'] = $this->course->id;

        $instance = $generator->create_instance($params, $options);
        $cm = get_coursemodule_from_instance('customdocument', $instance->id);
        $context = context_module::instance($cm->id);
        return new testable_customdocument($context, $cm, $this->course);
    }
 ...
 */
class testable_customdocument extends customdocument {

    const PLUGIN_VERSION = '2.2.2';

    /**
     * Overwrites parents to format $formdata
     * @see customdocument::update_instance()
     */
