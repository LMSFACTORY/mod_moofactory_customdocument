...
class backup_customdocument_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        // Define sources.
        $certificate->set_source_table('customdocument', array('id' => backup::VAR_ACTIVITYID));

        // All the rest of elements only happen if we are including user info.
        if ($userinfo) {
            $issue->set_source_table('customdocument_issues', array('certificateid' => backup::VAR_PARENTID));
        }
        ...
        $certificate->annotate_files(customdocument::CERTIFICATE_COMPONENT_NAME,
                        customdocument::CERTIFICATE_CERTIMAGE_FILE_AREA, null); // This file area hasn't itemid
